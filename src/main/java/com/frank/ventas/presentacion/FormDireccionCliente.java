...
import com.frank.ventas.control.DireccionClienteCONTROL;
import com.frank.ventas.entidades.Cliente;
import javax.swing.DefaultComboBoxModel;
import javax.swing.JOptionPane;
import javax.swing.table.TableRowSorter;

public class FormDireccionCliente extends javax.swing.JFrame {

    private final DireccionClienteCONTROL CONTROL;
    private String accion;

    public FormDireccionCliente() {
        initComponents();
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtCalle, javax.swing.GroupLayout.PREFERRED_SIZE, 251, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        if (tabla.getSelectedRowCount() == 1) {
            ...
            cboCliente.setSelectedItem(new Cliente(Integer.parseInt(rut), nombreCliente));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (accion.equals("editar")) {
            resp = CONTROL.actualizar(cliente.getRut(), txtCalle.getText(), numero, ciudad, comuna);
            if (resp.equals("OK")) {
            ...
            resp = CONTROL.insertar(cliente.getRut(), txtCalle.getText(), numero, ciudad, comuna);
            if (resp.equals("OK")) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormDireccionCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
